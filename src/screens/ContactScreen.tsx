    ...
    <div className="w-full bg-[#131314] text-[#e5e2e3] py-16 px-5 lg:px-20 max-w-[1440px] mx-auto space-y-20">
      ...
      <section className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-6 py-3.5 rounded-full bg-[#122416] border border-[#23582d] hover:border-[#38b04a] text-[#8ae899] hover:text-[#b4f6be] font-sans text-[11.5px] sm:text-[12px] font-bold tracking-widest uppercase transition-all shadow-lg group text-center"
        >
