...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className="w-full bg-[#0e0e0f] border-t border-[#4d4635]/30 pt-16 pb-28 sm:pb-14 text-[#d0c5af]">
      <div className="max-w-[1440px] mx-auto px-5 lg:px-20">
            ...
            <ul className="space-y-2.5 font-sans text-[13px]">
              <li>
                <button
                  ...
                  className="hover:text-[#f2ca50] transition-colors cursor-pointer text-left flex items-center gap-2"
                >
                  <span className="text-[#f2ca50] text-[10px]">■</span>
                  <span>Home (Sovereign Monograph)</span>
                </button>
              </li>
              <li>
                <button
                ...
                >
                  <span className="text-[#f2ca50] text-[10px]">■</span>
                  <span>About (Diplomatic Credentials)</span>
                </button>
              </li>
              <li>
                <button
                ...
                >
                  <span className="text-[#f2ca50] text-[10px]">■</span>
                  <span>Trade &amp; FDI (GCC–India Corridors)</span>
                </button>
              </li>
              <li>
                <button
                ...
                >
                  <span className="text-[#f2ca50] text-[10px]">■</span>
                  <span>Media &amp; Press (Cinema &amp; Press)</span>
                </button>
              </li>
              <li>
                <button
                ...
                >
                  <span className="text-[#f2ca50] text-[10px]">■</span>
                  <span>Women Leadership (National Mandate)</span>
                </button>
              </li>
              <li>
                <button
                ...
                >
                  ...
                  <span className="text-[9px] px-1.5 py-0.2 bg-[#f2ca50]/15 text-[#f2ca50] rounded font-mono">New</span>
                </button>
              </li>
              <li>
                <button
                ...
                >
                  <span className="text-[#f2ca50] text-[10px]">■</span>
                  <span>Contact (Chancery Desk)</span>
                </button>
              </li>
            </ul>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-[#4d4635]/20 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 font-sans text-[12.5px] sm:text-[13px]">
          <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-[#d0c5af]">
            <span className="inline-flex items-center gap-1.5 text-[#d0c5af]">
              <ShieldCheck className="w-4 h-4 text-[#f2ca50] shrink-0" />
              <span>256-Bit TLS Diplomatic Encryption Verified</span>
            </span>
            <span className="hidden sm:inline">&bull;</span>
            <span className="block sm:inline text-[#9e9584]">Office of Zeenat Kureshi &copy; 2026. All Rights Reserved.</span>
          </div>

          <div className="flex flex-wrap items-center gap-3.5 sm:gap-6 font-sans text-[10.5px] sm:text-[11px] font-semibold tracking-[0.14em] sm:tracking-[0.18em] uppercase pt-1 sm:pt-0">
            <button
              onClick={() => setActiveModal('privacy')}
              className="hover:text-[#f2ca50] transition-colors cursor-pointer py-0.5"
            >
              Protocol &amp; Privacy
            </button>
            <button
